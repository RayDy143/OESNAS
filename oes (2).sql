...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 18, 2018 at 02:39 PM
...
(96, 'qwerr12355@gmail.com', '123123', 'Verified', 2, 1, 0),
(98, 'q@gmail.com', '123', 'Verified', 23, 1, 0);
...
(22, 'Raymundo', 'Remiticado', 'Alfeche', '-', '2018-07-02', 'Male', '32423423423', 92),
...
--
ALTER TABLE `department`
  MODIFY `DepartmentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `nas`
--
ALTER TABLE `nas`
  MODIFY `NasID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `userinfo`
  MODIFY `UserInfoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `userprofilepicture`
--
ALTER TABLE `userprofilepicture`
  MODIFY `UserProfilePictureID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `userverificationcode`
  MODIFY `UserVerificationCodeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
COMMIT;
